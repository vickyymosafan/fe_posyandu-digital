...
Halaman ini menampilkan grafik tren kesehatan lansia dalam bentuk visualisasi chart untuk memudahkan analisis perkembangan kesehatan.

## Route

```
/petugas/lansia/[kode]/grafik
```
